...
- Vyrobíme $1|r_j,\tilde{d_j}|C_{max}$ rozvrhový problém I_{SCH} , který se skládá ze $4*m$ úloh $T_j=(p_j,r_jm)$ takový, že:
	- $\forall j \in \{1,..,m\}:T_j=(1,(B+1)*(j-1),(B+1)*(j-1)+1)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNjI2MTkxMzYsLTQ1NjQ1ODM2MiwtMj
